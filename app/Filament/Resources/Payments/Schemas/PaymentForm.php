                ...
                Section::make('Destino del Pago')
                    ...
                    ->schema([
                        ...
                        Select::make('case_id')
                            ...
                            ->options(fn (Get $get) => ClientCase::where('client_id', $get('client_id'))
                                ->pluck('case_name', 'id')
                            )
                            ->searchable()
                        ...
                        Select::make('procedure_id')
                            ...
                            ->options(fn (Get $get) => Procedure::whereHas('clientCase', fn ($q) => $q->where('client_id', $get('client_id')))
                                ->pluck('title', 'id')
                            )
                            ->searchable()
                        ...
                        Select::make('recurrent_id')
                            ...
                            ->options(fn (Get $get) => RecurrentPayment::where('client_id', $get('client_id'))
                                ->pluck('title', 'id')
                            )
